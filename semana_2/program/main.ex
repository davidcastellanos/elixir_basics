defmodule Library do
  ...
  def remove_book(library, isbn) do
    case Enum.filter(library, fn book -> book.isbn != isbn end) do
      ^library -> {:error, "Libro no encontrado"}
      updated_library -> {:ok, updated_library}
    end
  end
  ...
  ## Parameters
  - library: The current list of books in la biblioteca.
  - query: The title or author to search for.

  ## Examples

      iex> library = [
      ...>   %Library.Book{title: "Elixir in Action", author: "Saša Jurić", isbn: "1234567890"},
      ...>   %Library.Book{title: "Programming Elixir", author: "Dave Thomas", isbn: "0987654321"}
      ...> ]
